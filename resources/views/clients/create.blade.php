...
<h1>Novo Cliente</h1>
    <form action="{{route('clients.store')}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="endereco" name="endereco" placeholder="Rua um, Nº 123, Centro, Betim-MG" required>
        </div>
         <div class="mb-3">
            <label for="observacao" class="form-label">Observação</label>
            <textarea class="form-control" id="observacao" name="observacao" rows="3" required></textarea>
        </div>
        <button class="btn-lg btn-success" type="submit">Enviar</button>
